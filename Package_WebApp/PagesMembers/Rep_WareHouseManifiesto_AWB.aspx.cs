...
{
    public partial class WareHouseManifiesto_AWB : System.Web.UI.Page
    {
        string aa;
        protected void Page_Load(object sender, EventArgs e)
        {
            string mYo = (string)Session["m_AWB"]; // Tomar valor del otro forms
            ...
            else
            {
                ...
                ManifiestoNew_AWBTableAdapters.DataTable1TableAdapter ta = new ManifiestoNew_AWBTableAdapters.DataTable1TableAdapter();
                ManifiestoNew_AWB.DataTable1DataTable dt = new ManifiestoNew_AWB.DataTable1DataTable();
                ...
                foreach (ManifiestoNew_AWB.DataTable1Row row in dt.Rows)
                {
                ...
                ReportViewer1.LocalReport.ReportEmbeddedResource = "PagesMembers//WareHouseManifiesto_AWB.rdlc";
                ReportViewer1.LocalReport.ReportPath = @"PagesMembers/rdlc__WareHouseManifiesto_AWB.rdlc";   //   ~/PagesMembers/Reports/
