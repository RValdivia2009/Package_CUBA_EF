...
{
    public partial class WareHouseReceive : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {

            var ImageUrl="~/Iconos/Save-icon.png";
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        ReportViewer1.LocalReport.ReportPath = @"PagesMembers/rdlc__LabelWarehouse.rdlc";   //   ~/PagesMembers/Reports/
                        ...
                        if (FileBuffer != null)
                        {
                            ...
                            Response.BinaryWrite(FileBuffer);
                                    ...
                                    //  PARA TIRARLO POR REPORT VIEWER
                        //ReportViewer1.LocalReport.DataSources.Clear();
                        //ReportDataSource RD = new ReportDataSource();
                        //RD.Value = dt;
                        //RD.Name = "DataSet1";
                        //ReportViewer1.LocalReport.DataSources.Add(RD);
                        //ReportViewer1.LocalReport.ReportEmbeddedResource = @"PagesMembers/rdlc__LabelWarehouse.rdlc";
                        //ReportViewer1.LocalReport.ReportPath = @"PagesMembers/rdlc__LabelWarehouse.rdlc";
                        //ReportViewer1.LocalReport.Refresh();
